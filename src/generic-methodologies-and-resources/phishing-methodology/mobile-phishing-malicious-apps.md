...
- JPEG/PNG de `/sdcard/DCIM` comprimido con [Luban](https://github.com/Curzibn/Luban) para reducir el tamaño
- Contenido opcional de SMS (`content://sms`)
Los payloads son **comprimidos en lotes** y enviados a través de `HTTP POST /upload.php`.
6. **Técnica de Entrega de iOS**
...
3. Confiar en el perfil sin firmar ➜ el atacante obtiene derechos de *Contactos* y *Foto* sin revisión de la App Store.
7. **Capa de Red**
...
## Pruebas Defensivas / Consejos de Red-Team
