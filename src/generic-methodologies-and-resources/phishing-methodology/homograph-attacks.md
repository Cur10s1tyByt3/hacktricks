...
4. **Chaîne de redirection** – La victime est redirigée à travers des sites Web apparemment bénins ou des raccourcisseurs d'URL avant d'atterrir sur l'hôte malveillant qui collecte des identifiants / livre des logiciels malveillants.
...
* Implémenter la logique de détection ci-dessus dans les **Passerelles de Courriel Sécurisées** et les playbooks **SIEM/XSOAR**.
