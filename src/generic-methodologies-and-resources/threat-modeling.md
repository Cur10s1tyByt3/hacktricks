...
2. **Pruebas de Penetración**: El marco de Estándar de Ejecución de Pruebas de Penetración (PTES) requiere **modelado de amenazas para entender las vulnerabilidades del sistema** antes de llevar a cabo la prueba.
...
Los modelos de amenazas a menudo presentan elementos marcados en rojo, simbolizando vulnerabilidades, riesgos o barreras potenciales. Para agilizar el proceso de identificación de riesgos, se emplea el triángulo CIA (Confidencialidad, Integridad, Disponibilidad), que forma la base de muchas metodologías de modelado de amenazas, siendo STRIDE una de las más comunes. Sin embargo, la metodología elegida puede variar según el contexto y los requisitos específicos.
