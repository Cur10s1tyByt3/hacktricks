...
* Fer à souder, tresse à dessouder & pompe à dessouder
* Outils manuels classés ABS : scie à métaux, couteau utilitaire, limes plates & demi-rondes
...
3. Le déclencheur PD négocie 12 V depuis la batterie et l'alimente directement au MaxiProx (le lecteur s'attend nativement à 10–14 V). Un rail secondaire de 5 V est pris de la carte ESP pour alimenter les accessoires.
...
• Utilisez des coupe-fils à fleur puis un couteau & une lime pour *retirer* le "bump-out" interne en ABS afin que la grande batterie USB-C soit à plat sur le support.
...
* En utilisant une carte de test **Pupa** de 125 kHz, le cloner portable a obtenu des lectures cohérentes à **≈ 8 cm** en air libre – identique à l'opération alimentée par le secteur.
...
2. (Optionnel) Ouvrez le garde du beeper et activez le retour sonore lors des tests en laboratoire ; verrouillez-le avant une utilisation discrète sur le terrain.
