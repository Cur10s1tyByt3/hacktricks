...
1. **Compromission au niveau de la forêt** d'**un DC** (ou Administrateur d'Entreprise), ou accès `SYSTEM` à l'un des DC de la forêt.
...
Parce que le GUID est de 128 bits, le bruteforce naïf est irréaliste, mais :
...
* [`Semperis/GoldenGMSA`](https://github.com/Semperis/GoldenGMSA/) – implémentation de référence utilisée sur cette page.
