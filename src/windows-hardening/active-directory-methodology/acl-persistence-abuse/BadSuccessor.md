...
Como creaste el objeto dentro de una OU a la que puedes escribir, automáticamente posees todos sus atributos.
...
El PAC devuelto ahora contiene el SID 500 (Administrador) más los grupos de Administradores de Dominio/Administradores de Empresa.
