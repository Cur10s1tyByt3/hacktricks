...
Cette technique a été nommée **BadSuccessor** par l'Unité 42 en 2025. Au moment de la rédaction, **aucun correctif de sécurité** n'est disponible ; seule le renforcement des permissions d'OU atténue le problème.
...
L'Unité 42 a publié un script d'assistance PowerShell qui analyse les descripteurs de sécurité de chaque OU et met en évidence les ACE requis :
```powershell
...
- [BadSuccessor.ps1 – Collection d'outils de pentest](https://github.com/LuemmelSec/Pentest-Tools-Collection/blob/main/tools/ActiveDirectory/BadSuccessor.ps1)
