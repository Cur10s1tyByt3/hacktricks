...
| Parámetro | Propósito |
|-----------|---------|
| `MPKEYINFORMATIONMEDIA` | Devuelve la clave pública del certificado de firma del sitio + GUIDs de dispositivos **All Unknown Computers** *x86* / *x64*. |
...
Al relajar, el inicio de sesión se asigna a:
* `smsdbrole_MP`
* `smsdbrole_MPUserSvc`

Estos roles exponen docenas de permisos EXEC, los clave utilizados en este ataque son:
