...
| **GGML (formato GGUF)**      | **CVE-2024-25664 … 25668** (múltiples desbordamientos de heap)                                                                         | Archivo de modelo GGUF malformado causa desbordamientos de buffer en el analizador, habilitando la ejecución de código arbitrario en el sistema víctima                     | |
