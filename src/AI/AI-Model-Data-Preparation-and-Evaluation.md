...
El Matthews Correlation Coefficient (MCC) es una medida de la calidad de las clasificaciones binarias. Tiene en cuenta los verdaderos y falsos positivos y negativos, proporcionando una visión equilibrada del rendimiento del modelo. El MCC se calcula como:
```plaintext
...
> [!TIP]
> El MCC varía de -1 a 1, donde 1 indica una clasificación perfecta, 0 indica una adivinanza aleatoria y -1 indica un desacuerdo total entre la predicción y la observación. Es particularmente útil para conjuntos de datos desbalanceados, ya que considera los cuatro componentes de la matriz de confusión.
