...
*Ejemplo*: Los binarios de malware se etiquetan erróneamente como "benignos" en un corpus de entrenamiento de antivirus, permitiendo que malware similar pase desapercibido más tarde.
...
*Ejemplo*: Un backbone de visión con un desencadenante oculto aún cambia etiquetas después de ser adaptado para imágenes médicas.
...
- **Denial of ML Service**: Inundar APIs o enviar entradas "esponja" puede agotar recursos computacionales/energía y desconectar el modelo, reflejando ataques clásicos de DoS.
...
- **Model Evasion**: Entradas cuidadosamente diseñadas hacen que el modelo clasifique incorrectamente, alucine o produzca contenido no permitido, erosionando la seguridad y la confianza.
