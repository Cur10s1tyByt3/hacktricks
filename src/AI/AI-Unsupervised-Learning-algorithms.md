...
DBSCAN es un algoritmo de clustering basado en densidad que agrupa puntos que están estrechamente agrupados, mientras que marca los puntos en regiones de baja densidad como atípicos. Es particularmente útil para conjuntos de datos con densidades variables y formas no esféricas.
