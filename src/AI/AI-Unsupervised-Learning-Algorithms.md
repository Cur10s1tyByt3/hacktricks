...
<details>
<summary>Ejemplo -- Agrupamiento con Ruido
</summary>
```python
...
* **Evasión de DBSCAN/HDBSCAN.** Un preprint académico de 2025 de KU Leuven mostró que un atacante puede crear patrones de balizamiento que caen intencionadamente en huecos de densidad, ocultándose efectivamente dentro de etiquetas de *ruido*.
...
2. **Ensamblaje de consenso.** Combinar varios detectores heterogéneos (por ejemplo, Isolation Forest + GMM + ECOD) y generar una alerta si *cualquier* modelo señala un punto. La investigación indica que esto aumenta el costo para el atacante en más de 10×.
