...
```
> [!TIP]
> **Gradient clipping** es una técnica utilizada para mejorar la **estabilidad del entrenamiento** en grandes redes neuronales al establecer un **umbral máximo** para las magnitudes de los gradientes. Cuando los gradientes superan este `max_norm` predefinido, se reducen proporcionalmente para asegurar que las actualizaciones a los parámetros del modelo se mantengan dentro de un rango manejable, previniendo problemas como gradientes explosivos y asegurando un entrenamiento más controlado y estable.
>
...
Las funciones `create_dataloader_v1` y `create_dataloader_v1` ya fueron discutidas en una sección anterior.
...
>
> _Nota que estas mejoras no están incluidas en el código anterior._
