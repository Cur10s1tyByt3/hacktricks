...
_(Asumiendo que `[UNK]` tiene ID `987`)_

### **Advanced Tokenizing Methods**

Mientras que el tokenizador básico funciona bien para textos simples, tiene limitaciones, especialmente con vocabularios grandes y al manejar palabras nuevas o raras. Los métodos avanzados de tokenización abordan estos problemas descomponiendo el texto en subunidades más pequeñas o optimizando el proceso de tokenización.
