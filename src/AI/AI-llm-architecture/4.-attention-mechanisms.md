...
Similar al ejemplo anterior, pero esta vez, en lugar de usar los valores de las dimensiones de los tokens, usamos la matriz clave del token (ya calculada usando las dimensiones):. Así que, para cada consulta `qi`​ y clave `kj​`:

<figure><img src="../../images/image (12).png" alt=""><figcaption></figcaption></figure>

**Escalar las Puntuaciones**

Para evitar que los productos punto se vuelvan demasiado grandes, escálalos por la raíz cuadrada de la dimensión clave `dk`​:
