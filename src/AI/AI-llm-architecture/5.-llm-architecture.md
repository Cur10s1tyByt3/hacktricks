...
3. **Bloques de Transformador**: El modelo contiene **12 bloques de transformador**, cada uno con múltiples capas. Estos bloques repiten la siguiente secuencia:
