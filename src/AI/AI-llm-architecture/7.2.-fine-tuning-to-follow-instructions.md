...
- Rellenar todas las muestras a la misma longitud (generalmente la longitud será tan grande como la longitud del contexto utilizada para pre-entrenar el LLM)
...
Otra prueba para verificar la calidad de las respuestas:
