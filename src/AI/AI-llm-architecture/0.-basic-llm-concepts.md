...
- **Número de cabezas de atención**: En los modelos de transformadores, esta es la cantidad de mecanismos de atención separados que se utilizan en cada capa. Los LLM suelen usar decenas de cabezas.
...
```
### Operaciones Comunes de Tensores
